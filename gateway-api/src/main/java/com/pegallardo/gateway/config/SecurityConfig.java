...
import com.pegallardo.gateway.security.filter.HttpMethodValidationFilter;
import com.pegallardo.gateway.security.filter.JwtAuthenticationFilter;

/**
 * Security configuration using the latest Spring Security features
 * Implements JWT authentication, CORS, and endpoint security
 */
@Configuration
@EnableWebSecurity
